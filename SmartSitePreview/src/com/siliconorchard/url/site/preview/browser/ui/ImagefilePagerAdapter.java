...
public class ImagefilePagerAdapter extends PagerAdapter {
	private final static String stpos="";
	private String[] images;
	private LayoutInflater inflater;

	public ImagefilePagerAdapter(String[] images) {
		this.images = images;
		inflater = ((Activity) HowtouseActivity.c).getLayoutInflater();
	}
...
/*		Animation anim = AnimationUtils.loadAnimation(PreviewImage.c, R.anim.fade_out);
	...
	//	if(imageUrl=="")
		...
		PreviewfileImage.imageLoader.displayImage(images[position], imageView, options, new ImageLoadingListener() {
			...
			public void onLoadingComplete(String arg0, View arg1, Bitmap arg2) {
				// TODO Auto-generated method stub
				spinner.setVisibility(View.GONE);
			/*	Animation anim = AnimationUtils.loadAnimation(PreviewfileImage.c, R.anim.fade_out);
				imageView.setAnimation(anim);
				anim.start();*/
			}
